...
export default function FamilyNode({ node, isSelected, isDimmed, isLinkTarget, isGroupMemberHighlighted, onPointerDown }) {
  ...
  return (
    ...
    >
      ...
      {isGroupMemberHighlighted && !isDimmed && (
        <line x1="-20" y1="66" x2="20" y2="66" stroke="#F97316" strokeWidth="3" strokeLinecap="round" />
      )}
    </g>
  );
}
