...
import { Target, Download, LogOut, Menu, X, Camera, LayoutGrid } from 'lucide-react';

export default function CanvasHUD({ username, nodeCount, zoom, onFitToScreen, onOrganize, onExport, onSnapshot, onLogout }) {
