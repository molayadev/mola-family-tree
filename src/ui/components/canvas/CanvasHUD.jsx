...
import { Target, Download, LogOut, Menu, X, Camera, LayoutGrid, Minimize2, Maximize2, Link as LinkIcon } from 'lucide-react';

export default function CanvasHUD({ username, nodeCount, zoom, onFitToScreen, onOrganize, onManageLinkTypes, onExport, onSnapshot, onLogout, hasFamilies, hasCollapsed, onToggleCollapseAll }) {
